<?php
$pagetitle ="View producst";
$activeProductsParent= "active open";
$activeViewProduct = "active";
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
											...
											<?php
											$products_query = "select * from shop_items";
												...
												<?php foreach ($products as $item) :?>
													<tr>
														...
														<td>
															...
															<a class="green" href="edit-product.php?id=<?php echo $item['Id']; ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red delete_product" data-id="<?php echo $item['Id']; ?>" href="javascipt:void(0)">
				...
				bootbox.dialog({
					...
					danger: {
						...
						callback: function() {
							...
							$.post('../custom/deleteproduct.php', { 'delete':pid })
