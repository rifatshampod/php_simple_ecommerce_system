...
<div class="landing-page"><h2 align='center'> Get General Appointment </h2><div class="form-appointment"><div class="wpcf7" id="wpcf7-f560-p590-o1"><form action="appointment.php" method="post" class="wpcf7-form" novalidate="novalidate" _lpchecked="1">
...
<form action="appintment.php" method = "post">
<input type="text" name="name" value="" size="45" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" placeholder="Name"></span><br>
<input type="email" name="mail" value="" size="45" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" placeholder="Email"></span><br>
<input type="tel" name="phone" value="" size="45" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel" aria-required="true" placeholder="Phone"></span><br>
<textarea name="textarea-398" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" placeholder="Special notes, concerns, or requirements"></textarea></span></div>
<div style="width: 48%; float: right;">
<h4>What is the best way to reach you?</h4>
<p><input type="radio" name="pre" value="Phone">&nbsp;<span class="wpcf7-list-item-label">Phone &nbsp &nbsp <input type="radio" name="pre" value="Email"> &nbsp;<span class="wpcf7-list-item-label">Email</span></label></span></span></span></p>
...
<p><span class="wpcf7-form-control-wrap checkbox-246"><span class="wpcf7-form-control wpcf7-checkbox"><span class="wpcf7-list-item"><label><input type="checkbox" name="time[]" value="8am - 10am">&nbsp;<span class="wpcf7-list-item-label">Morning</span></label></span><span class="wpcf7-list-item"><label><input type="checkbox" name="time[]" value="3pm - 5pm">&nbsp;<span class="wpcf7-list-item-label">Afternoon</span></label></span></span></span></p></div>
</div>
<div style="text-align: center; padding-top: 2em; border-top: 1px solid rgb(153, 202, 129); margin-top: 1em;"><input type="submit" value="Request My Appointment" class="wpcf7-form-control wpcf7-submit"> </div> </form>
  <div class="wpcf7-response-output wpcf7-display-none"></div></form></div></div></div>
</div>

<div>
<h1 align = 'center'> Book Vaterian For your pet </h1>
<br>
<table style="width:60%" align ='center'>
<tr><th>Name  </th><th>Specialization</th> <th>Position</th> <th>Contact</th> <th>Book</th> </tr>
<tr><td>Dr Azmir Shah  </td><td>Surgeon</td> <td>Secratery,<br> Malaysian veterians</td><td>0112334563</td> <td>Book</td> </tr>
<tr><td>Dr Azmir Shah  </td><td>Surgeon</td> <td>Secratery,<br> Malaysian veterians</td><td>0112334563</td> <td>Book</td> </tr>
<tr><td>Dr Azmir Shah  </td><td>Surgeon</td> <td>Secratery,<br> Malaysian veterians</td><td>0112334563</td> <td>Book</td> </tr>
<tr><td>Dr Azmir Shah  </td><td>Surgeon</td> <td>Secratery,<br> Malaysian veterians</td><td>0112334563</td> <td>Book</td> </tr>
</table>
