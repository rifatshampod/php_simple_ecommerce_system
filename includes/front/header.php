...
<head>
    ...
    <title>Pet Monitor | E-Shopper</title>
					...
					<div class="col-sm-6 ">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> +60142275453</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> info@petmonitor.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php"><img src="assets/front/images/home/logo.jpg" alt="" size='50%' /></a>
						</div>
				...
				<div class="row">
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
						  ...
						  <li><a href="book_vat.php" class="<?php if(isset($active)){echo $active;} ?>">Book Veterinary</a></li>
